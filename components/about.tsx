    ...
    <section className="w-full bg-black py-16 md:py-24">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 py-12 md:grid-cols-12 md:gap-12 md:px-8">
        ...
        <div className="flex flex-col md:col-span-8">
          ...
          <div className="space-y-5 text-sm leading-relaxed text-gray-300 md:text-base">
            <p>
              ...
              <span className="font-semibold text-white">
                Content Writer and SEO Content Writer
              </span>{" "}
              with 3 years of experience creating clear, engaging, and
              search-friendly content for websites and blogs.
            </p>

            <p>
              My expertise includes{" "}
              <span className="font-semibold text-white">
                SEO content writing, article writing, blog writing, SEO, and
                web design.
              </span>{" "}
              I focus on creating original, well-structured content that is
              easy to read, useful for the audience, and optimized for search
              engines.
            </p>

            <p>
              Over the past 3 years, I have worked on different types of
              content and websites, helping businesses and website owners
              improve their online presence through quality content and
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={skill}
                  className="border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-gray-300 transition-all duration-200 hover:border-yellow-500/40 hover:bg-yellow-500/5 hover:text-yellow-400"
                >
          ...
          {/* Closing content */}
          <div className="mt-7 space-y-5 text-sm leading-relaxed text-gray-300 md:text-base">
            <p>
              I believe good content should do more than fill a webpage. It
              should provide real value to readers while supporting a
              website&apos;s visibility and growth in search results.
            </p>

            <p>
              I&apos;m always focused on delivering high-quality, original,
              reader-friendly, and SEO-optimized content that matches the goals
              of each project.
            </p>
          </div>
